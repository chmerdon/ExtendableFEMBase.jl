...
function get_basis(::Type{ON_CELLS}, ::Type{HCURLN0{3}}, ::Type{<:Tetrahedron3D})
    function closure(refbasis,xref) # [1 2; 1 3; 1 4; 2 3; 2 4; 3 4]
        refbasis[1,1] = 1.0-xref[2]-xref[3];    refbasis[1,2] = xref[1];            refbasis[1,3] = xref[1]             # edge 1 = [1,2] (y=z=0)        t = (1,0,0)
        refbasis[2,1] = xref[2];                refbasis[2,2] = 1-xref[3]-xref[1];  refbasis[2,3] = xref[2]             # edge 2 = [1,3] (x=z=0)        t = (0,1,0)
        refbasis[3,1] = xref[3];                refbasis[3,2] = xref[3];            refbasis[3,3] = 1-xref[1]-xref[2]   # edge 3 = [1,4] (x=y=0)        t = (0,0,1)
        refbasis[4,1] = -xref[2];               refbasis[4,2] = xref[1];            refbasis[4,3] = 0                   # edge 4 = [2,3] (z=0, y=1-x)   t = (-1,1,0)
        refbasis[5,1] = -xref[3];               refbasis[5,2] = 0;                  refbasis[5,3] = xref[1]             # edge 5 = [2,4] (y=0, z=1-x)   t = (-1,0,1)
        refbasis[6,1] = 0;                      refbasis[6,2] = -xref[3];           refbasis[6,3] = xref[2]             # edge 6 = [3,4] (x=0, z=1-y)   t = (0,-1,1)
    end
end
